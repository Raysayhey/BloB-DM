...
---
### Welcome to DM-Block
These terms and conditions outline the rules and regulations for the use of DM-Block's Website.

By accessing this website we assume you accept these terms and conditions in full. Do not continue to use DM-Block's website if you do not accept all of the terms and conditions stated on this page.
...
1. Republish material from https://www.dm-block.ch
2. Sell, rent or sub-license material from https://www.dm-block.ch
3. Reproduce, duplicate or copy material from https://www.dm-block.ch

Redistribute content from DM-Block (unless content is specifically made for redistribution).
...
If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to marketing@dm-block.ch. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.
...
No use of DM-Block’s logo or other artwork will be allowed for linking absent a trademark license agreement.
